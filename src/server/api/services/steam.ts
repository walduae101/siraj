...
import { loadServerEnv, clientEnv } from "~/env";
...
export default class SteamService {
  public static async getLoginUrl() {
    const params = {
      ...
      "openid.return_to": `${clientEnv.NEXT_PUBLIC_WEBSITE_URL}/auth/steam/return`,
      "openid.realm": clientEnv.NEXT_PUBLIC_WEBSITE_URL,
